// mekanism/crushing.js
// ─────────────────────────────────────────────────────────
// Mekanism 粉碎（crushing）配方 - 来自原 mek/mek_recipe_crush.js
// ExDeorum 碎块产出：把原矿/压缩方块磨成 ExDeorum 碎块。
// 同一功能在 create/crushing.js 也有（Create 粉碎），属于并存路径。
// ─────────────────────────────────────────────────────────
